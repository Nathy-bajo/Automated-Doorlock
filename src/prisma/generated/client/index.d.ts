...
/**
   ...
   * `prisma.door`: Exposes CRUD operations for the **Door** model.
    ...
    * ```
    */
  get door(): Prisma.DoorDelegate<GlobalReject>;
  ...
  */
  ...
  export type DoorAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<DoorOrderByWithRelationInput>
    /**
  ...
  export type DoorGroupByArgs = {
    where?: DoorWhereInput
    orderBy?: Enumerable<DoorOrderByWithAggregationInput>
    by: Array<DoorScalarFieldEnum>
  ...
  type GetDoorGroupByPayload<T extends DoorGroupByArgs> = PrismaPromise<
    Array<
      PickArray<DoorGroupByOutputType, T['by']> &
        {
  ...
  export type DoorSelect = {
    id?: boolean
    state?: boolean
  }

  export type DoorGetPayload<
    S extends boolean | null | undefined | DoorArgs,
    U = keyof S
      > = S extends true
        ? Door
    : S extends undefined
    ? never
    : S extends DoorArgs | DoorFindManyArgs
    ?'include' extends U
    ? Door 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Door ? Door[P] : never
  } 
    : Door
  : Door


  type DoorCountArgs = Merge<
    Omit<DoorFindManyArgs, 'select' | 'include'> & {
      select?: DoorCountAggregateInputType | true
    }
  >

  export interface DoorDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends DoorFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, DoorFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Door'> extends True ? CheckSelect<T, Prisma__DoorClient<Door>, Prisma__DoorClient<DoorGetPayload<T>>> : CheckSelect<T, Prisma__DoorClient<Door | null >, Prisma__DoorClient<DoorGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends DoorFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, DoorFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Door'> extends True ? CheckSelect<T, Prisma__DoorClient<Door>, Prisma__DoorClient<DoorGetPayload<T>>> : CheckSelect<T, Prisma__DoorClient<Door | null >, Prisma__DoorClient<DoorGetPayload<T> | null >>
     ...
     * 
    **/
    findMany<T extends DoorFindManyArgs>(
      args?: SelectSubset<T, DoorFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Door>>, PrismaPromise<Array<DoorGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends DoorCreateArgs>(
      args: SelectSubset<T, DoorCreateArgs>
    ): CheckSelect<T, Prisma__DoorClient<Door>, Prisma__DoorClient<DoorGetPayload<T>>>
     ...
     * 
    **/
    delete<T extends DoorDeleteArgs>(
      args: SelectSubset<T, DoorDeleteArgs>
    ): CheckSelect<T, Prisma__DoorClient<Door>, Prisma__DoorClient<DoorGetPayload<T>>>
     ...
     * 
    **/
    update<T extends DoorUpdateArgs>(
      args: SelectSubset<T, DoorUpdateArgs>
    ): CheckSelect<T, Prisma__DoorClient<Door>, Prisma__DoorClient<DoorGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends DoorDeleteManyArgs>(
      args?: SelectSubset<T, DoorDeleteManyArgs>
     ...
     * 
    **/
    updateMany<T extends DoorUpdateManyArgs>(
      args: SelectSubset<T, DoorUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends DoorUpsertArgs>(
      args: SelectSubset<T, DoorUpsertArgs>
    ): CheckSelect<T, Prisma__DoorClient<Door>, Prisma__DoorClient<DoorGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends DoorAggregateArgs>(args: Subset<T, DoorAggregateArgs>): PrismaPromise<GetDoorAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, DoorGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDoorGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   */
  export class Prisma__DoorClient<T> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   * Door findUnique
   */
  export type DoorFindUniqueArgs = {
    /**
     * Select specific fields to fetch from the Door
     * 
    **/
    select?: DoorSelect | null
    /**
     * Throw an Error if a Door can't be found
     * 
    **/
  ...
  export type DoorFindFirstArgs = {
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<DoorScalarFieldEnum>
  }
   ...
   * Door updateMany
   */
  export type DoorUpdateManyArgs = {
    /**
   ...
   * Door deleteMany
   */
  export type DoorDeleteManyArgs = {
    /**
  ...
  export type DoorWhereInput = {
    AND?: Enumerable<DoorWhereInput>
    OR?: Enumerable<DoorWhereInput>
    NOT?: Enumerable<DoorWhereInput>
    id?: IntFilter | number
  ...
  export type DoorWhereUniqueInput = {
    id?: number
  }
  ...
  export type DoorScalarWhereWithAggregatesInput = {
    AND?: Enumerable<DoorScalarWhereWithAggregatesInput>
    OR?: Enumerable<DoorScalarWhereWithAggregatesInput>
    NOT?: Enumerable<DoorScalarWhereWithAggregatesInput>
  ...
  export type UserWhereInput = {
    ...
    device_token?: StringNullableFilter | string | null
  }
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    device_token?: StringNullableWithAggregatesFilter | string | null
  }
